...
- **Xóa**: Chỉ được xóa khu khi **tất cả phòng trong khu đang ở trạng thái Đang trống** và không có hóa đơn chưa thanh toán. Nếu vi phạm, hệ thống hiện thông báo lỗi.
...
3. Nếu đủ điều kiện: hiện hộp thoại xác nhận → QL xác nhận → hệ thống xóa và thông báo thành công.
...
**Luồng nghiệp vụ:**
1. QL chọn menu **Quản lí khách hàng** → danh sách KH hiện ra (họ tên, số CMND/CCCD, số điện thoại, trạng thái hiện tại).
...
3. QL click vào 1 KH → hệ thống hiển thị:
   ...
   - **Trạng thái nợ**: tổng nợ hiện tại (nếu có).

---

### 1.4 Module: Làm hợp đồng cho thuê phòng
...
### 1.5 Module: Gia hạn hợp đồng

**Luồng nghiệp vụ:**
1. QL chọn **Gia hạn hợp đồng** → tìm hợp đồng theo tên KH / tên phòng.
...
### 1.6 Module: Lên hóa đơn tháng cho khách hàng
...
### 1.7 Module: Thanh toán hàng tháng
...
4. QL nhận tiền và click **Xác nhận đã thanh toán** → hệ thống cập nhật trạng thái hóa đơn thành "Đã thanh toán" và ghi lại ngày thanh toán.
5. QL ký xác nhận vào hóa đơn trả cho KH.

---

### 1.8 Module: Thống kê doanh thu
...
### 1.11 Module: Quản lí người ở trong phòng
...
### 1.12 Module: Quản lí đơn giá dịch vụ
...
### 1.13 Module: Cảnh báo & nhắc nhở

**Chức năng:** Hiển thị các cảnh báo quan trọng ngay trên trang chủ / dashboard của QL dưới dạng danh sách thẻ cảnh báo, phân nhóm theo loại.
...
### 1.15 Module: Quản lí sửa chữa & bảo trì
...
|---|---|---|
| Đang trống | Chưa có KH, sẵn sàng cho thuê | Đang cho thuê (khi ký HĐ), Đang sửa chữa |
| Đang cho thuê | Có hợp đồng đang hiệu lực | Đang trống (khi thanh lý / hủy HĐ) |
| Đã đặt cọc | Đã nhận cọc, chờ KH vào ở | Đang cho thuê (khi KH vào ở) |
