...
| **Khách hàng (KH)** | Có thể thuê nhiều phòng ở nhiều thời điểm khác nhau; mỗi KH có thể đang thuê tối đa 1 phòng tại 1 thời điểm |
...
- **Không áp dụng lãi suất** khi quá hạn; thay vào đó áp dụng quy tắc hủy hợp đồng (xem mục 3.6).
...
| **4.2 Quản lí thông tin phòng** | Thêm, sửa, xóa thông tin phòng và loại phòng |
| **4.3 Quản lí khách hàng** | Xem danh sách KH, tìm kiếm, xem lịch sử thuê phòng của từng KH |
| **4.4 Làm hợp đồng cho thuê phòng** | Tìm phòng trống, nhập thông tin KH, tạo và in hợp đồng |
| **4.5 Gia hạn hợp đồng** | Cập nhật ngày hết hạn mới, lưu lịch sử gia hạn |
| **4.6 Lên hóa đơn tháng** | Nhập chỉ số điện/nước, số lượng xe, tính và in hóa đơn hàng tháng |
| **4.7 Thanh toán hàng tháng** | Tra cứu và xác nhận thanh toán hóa đơn |
| **4.8 Thống kê doanh thu** | Thống kê theo tháng/quý/năm, chi tiết theo hóa đơn |
| **4.9 Thanh lý hợp đồng** | Kết thúc hợp đồng, tính hoàn cọc, in biên bản |
| **4.10 Hủy hợp đồng** | Hủy hợp đồng do vi phạm nghĩa vụ thanh toán, giữ cọc, in biên bản |
| **4.11 Quản lí người ở trong phòng** | Theo dõi danh sách người thực tế để tính tiền vệ sinh |
| **4.12 Quản lí đơn giá dịch vụ** | Cập nhật và lưu lịch sử đơn giá theo loại phòng |
| **4.13 Cảnh báo & nhắc nhở** | Hiển thị cảnh báo trên dashboard theo thời gian thực |
| **4.14 Báo cáo nâng cao** | Báo cáo công suất, nợ, doanh thu theo khu/phòng, xuất Excel/PDF |
| **4.15 Quản lí sửa chữa & bảo trì** | Ghi nhận, theo dõi sự cố và chi phí bảo trì từng phòng |
...
| NFR-8 | Hệ thống là ứng dụng desktop hoặc web nội bộ, chạy trên máy đơn, không yêu cầu kết nối internet. |
